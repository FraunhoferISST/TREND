...
class ZipWatermark(content: List<Byte>) : Watermark(content) {
    /** Represents the Watermark by [rawContent] as String */
    override fun toString(): String = this.rawContent.toByteArray().contentToString()
}
...
object ZipWatermarker : FileWatermarker<ZipFile, ZipWatermark> {
    ...
    override fun addWatermark(
        ...
        return file.header.addExtraField(ZIP_WATERMARK_ID, watermark.rawContent)
    }
