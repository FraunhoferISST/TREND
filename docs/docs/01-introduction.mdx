...
Welcome to the Innamark documentation!

If you are interested in ...

- ... just testing Innamark: Have a look at the [Getting Started](/docs/getting-started) guide.
- ... using the Innamark watermarker library in your software project or using a command line tool 
