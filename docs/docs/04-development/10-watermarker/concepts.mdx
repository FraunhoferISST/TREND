...
generating watermarks and parsing extracted watermarks:
 ...
 For more details see [`Trendmark`](../trendmark). This implies that a user extracting a `Trendmark`
 must know the type of content but not the format used to store the content.
