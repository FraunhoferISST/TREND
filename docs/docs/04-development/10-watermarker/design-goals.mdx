...
can be exchanged with another class implementing the interface. 
   - *example*: class
   [`TextWatermarker`](https://github.com/FraunhoferISST/TREND/blob/main/watermarker/src/commonMain/kotlin/fileWatermarker/TextWatermarker.kt#L37)
...
using linters. For more information see
[`CONTRIBUTING.md`](https://github.com/FraunhoferISST/TREND/blob/main/CONTRIBUTING.md).

- **Testing**: For every new code added to the library tests should be added to validate the
...
**Devs working on the project should try to follow these goals!**
